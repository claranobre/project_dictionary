...
public:
	 ...
	 */
	bool addFirst(const Data &value);
	 ...
	 * @return      Verdadeiro se o elemento foi adicionado ou falso caso contrário (memória cheia, por exemplo)
	 */
	bool add(const Data &value, int pos = 0);
